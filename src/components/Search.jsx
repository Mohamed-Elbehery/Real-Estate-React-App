...
import { CountryDropdown, PropertyDropdown, PriceRangeDropdown } from "./index";
...
const Search = () => {
  ...
  return (
    ...
    lg:gap-x-3 relative lg:-top-3 lg:shadow-1 bg-white lg:bg-transparent lg:backdrop-blur rounded-lg"
    >
      <CountryDropdown />
      <PropertyDropdown />
      <PriceRangeDropdown />
